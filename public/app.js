(function () {
  ...
  function renderBanner() {
    ...
    const reason = latestState && latestState.lastError ? ` (${latestState.lastError})` : '';
    if (bannerTextEl) bannerTextEl.textContent = `${backendLabel()} is offline — showing the last known state${reason}`;
    if (connected) {
